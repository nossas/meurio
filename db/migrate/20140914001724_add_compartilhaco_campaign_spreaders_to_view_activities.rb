class AddCompartilhacoCampaignSpreadersToViewActivities < ActiveRecord::Migration
  def up
    ...
    UNION ALL
    SELECT compartilhaco_campaign_spreaders.id, compartilhaco_campaign_spreaders.user_id, compartilhaco_campaign_spreaders.created_at, compartilhaco_campaign_spreaders_campaigns.hashtag, 'compartilhaco_campaign_spreaders' as relname FROM compartilhaco_campaign_spreaders INNER JOIN compartilhaco_campaigns compartilhaco_campaign_spreaders_campaigns ON (compartilhaco_campaign_spreaders_campaigns.id = compartilhaco_campaign_spreaders.campaign_id)"
  end
