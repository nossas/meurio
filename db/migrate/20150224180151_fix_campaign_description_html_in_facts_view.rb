class FixCampaignDescriptionHtmlInFactsView < ActiveRecord::Migration
  def up
    drop_view :facts
    create_view :facts, <<-SQL
      ...
      SELECT panela_campaigns.id, panela_campaigns.created_at,  panela_campaigns.name,  panela_campaigns.description_html,  '' as link, panela_campaigns.hashtag, 'panela_campaigns' as relname         FROM panela_campaigns
    SQL
  end
