class AddPanelaCampaignsTableToFactsView < ActiveRecord::Migration
  def up
    drop_view :facts
  ...
  def down
    ...
    UNION ALL
    SELECT cc.id, cc.created_at, cc.title as name, cc.description as description_html, '' as link, cc.hashtag, 'compartilhaco_campaigns' as relname FROM compartilhaco_campaigns cc;"
  end
end
