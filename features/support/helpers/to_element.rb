def to_element string
  ...
  when "this poke in the activity feed"
    ".user_right .PanelaPoke"
  when "this campaign in the activity feed"
    ".user_right .PanelaCampaign"
  when "this idea in the activity feed"
    ".user_right .Idea"
  when "this problem in the activity feed"
    ".user_right .Problem"
  when "this Compartilhaço campaign in the activity feed"
    ".user_right .CompartilhacoCampaign"
  when "this Compartilhaço Facebook profile spreader in the activity feed"
    ".user_right .CompartilhacoFacebookProfileSpreader"
  when "this Compartilhaço Twitter profile spreader in the activity feed"
    ".user_right .CompartilhacoTwitterProfileSpreader"
  when "users"
    sleep 1
    "#users .member"
  when "team members"
