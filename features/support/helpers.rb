...
def to_element string
  ...
  return ".history .item.petitions"                                                   if string == "the petition on the mobilization history"
  ...
  return ".shares_counter .counter"                                                   if string == "the Facebook shares counter"
  return ".attending_count .counter"                                                  if string == "the attendees counter"
  return ".signatures_count .counter"                                                 if string == "the signatures counter"
  ...
  return "img[src='#{@user.avatar_url}']"                                             if string == "this user image"
  return ".user_name"                                                                 if string == "this user name"
  return ".user_profession"                                                           if string == "this user profession"
  return ".user_facebook_url[href='https://www.facebook.com/#{@user.facebook}']"      if string == "this user Facebook link"
  return ".user_twitter_url[href='https://twitter.com/#{@user.twitter}']"             if string == "this user Twitter link"
  return ".user_city"                                                                 if string == "this user city"
  return ".user_district"                                                             if string == "this user district"
