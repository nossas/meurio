...
def to_element string
  ...
  return ".user_facebook_url[href='https://www.facebook.com/#{@user.facebook_url}']"  if string == "this user Facebook link"
  return ".user_twitter_url[href='https://twitter.com/#{@user.twitter_url}']"         if string == "this user Twitter link"
...
def to_text string
  ...
  return @user.home_address_district                if string == "this user district"
